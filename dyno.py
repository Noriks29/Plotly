...
class GrandSolver(object):
    ...
    def read_bpmn(self, bpmn_file):
        ...
        for reselement in root.iterfind("mdl:resource", nsmap):
            res_threads = reselement.xpath("mdl:extensionElements/ltsm:props[@name='threads']/@value", namespaces=nsmap) or [None]
            res_price = reselement.xpath("mdl:extensionElements/ltsm:props[@name='price']/@value", namespaces=nsmap) or [None]
            res_productivity = reselement.xpath("mdl:extensionElements/ltsm:props[@name='productivity']/@value", namespaces=nsmap) or [None]
        ...
        for procelement in root.iterfind("mdl:process", nsmap):
            ...
            for opelement in procelement.iterfind("mdl:task", nsmap):
                ...
                op_volume = op_volume or opelement.xpath("mdl:extensionElements/ltsm:props[@name='volume']/@value", namespaces=nsmap)
                ...
                for performerelement in opelement.iterfind("mdl:performer", nsmap):
                    dyn.ProductivityMatrix[tempop.ID, performerelement.find("mdl:resourceRef", nsmap).text] = \
                        float((performerelement.xpath("mdl:resourceParameterBinding/mdl:formalExpression/text()", namespaces=nsmap) or [1])[0])
                    if DEBUG:
